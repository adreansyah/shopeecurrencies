...
class API {
  ...
  createEntities(arrayOfEntity: Array<*>) {
  ...
  createBasicCRUDEndpoints({ name }) {
    ...
    endpoints.updateById = (id: number, config: null) =>
      axios.put(`${resourceURL}/${id}`, config);

    endpoints.delete = (id: number, config: null) =>
